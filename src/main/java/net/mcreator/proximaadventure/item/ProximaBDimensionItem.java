...
package net.mcreator.proximaadventure.item;
...
public class ProximaBDimensionItem extends Item {
	public ProximaBDimensionItem(Item.Properties properties) {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				ProximaBDimensionPortalBlock.portalSpawn(world, pos);
